...
echo "============================================================"
echo " Starting Gemma 4 Dialogs Evaluation (SGLang)"
echo "============================================================"
...
if [ -n "${SLURM_TMPDIR:-}" ] && [ -d "${SLURM_TMPDIR}" ]; then
  SCRATCH_ROOT="${SLURM_TMPDIR}/${SLURM_JOB_ID:-eval_scratch_dialogs}"
...
# Execute evaluation_dialogs.py inside the SGLang container in offline mode
apptainer exec \
  --nv \
  ...
  "${CONTAINER_PYTHON}" /repo/src-eval/evaluation_dialogs.py

echo "============================================================"
echo "[SUCCESS] Gemma 4 Dialogs Evaluation finished!"
echo "============================================================"
